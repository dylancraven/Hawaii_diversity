...
**Table 4.** Sampled area, number of plots, and number of individuals and species per island across the Hawaiian archipelago (10 plots; only alien species; both sampling scenarios).      
```{r, echo=FALSE}
...
**Table 5.** Sampled area, number of plots, and number of individuals and species per island across the Hawaiian archipelago (10 plots; native species; Het + Age and Age scenario (using elevation range, not aridity)).
...
haw_scen3<-read.csv("/home/dylan/Dropbox (iDiv)/Research_projects/Veg. monitoring databases/databases and field protocols/database/IslandForests/Hawaii_only/Diversity_Age/Hawaii_diversity/Cleaned_Data/Scen3_Natives_ElevR_10plots_Envconditions_summarized.csv",sep=",",header=T)
