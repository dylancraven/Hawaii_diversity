...
h_stats<-calc_biodiv(h_comm3, groups=groupss,effort=100,extrapolate=TRUE,index=c("N","S","S_n","S_asymp","S_PIE"),return_NA=FALSE)
...
h_map_data<-distinct(select(datt, geo_entity2, PlotID, Lat_Dec, Long_Dec, MAT, MAP, PET, Plot_Prop_Invaded))
