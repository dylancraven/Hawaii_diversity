...
HillN_2<-read.csv("Cleaned_Data/Scen2_Natives_5plots_HillN.csv")
...
write.csv(HillNN_f,"Cleaned_Data/summaryHillNumbers_5plots.csv",row.names = FALSE)
...
png(filename="Figures/HillN_Natives_5plots_Fig4.png", 
    units="in", 
    width=7, 
    height=7, 
    pointsize=2, 
