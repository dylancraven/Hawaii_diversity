...
#   geom_point(data=H_Sc1_Or0, aes(x=geo_entity2,y=qD,color=geo_entity2),position = position_jitter(w = 0.02, h = 0),size=0.25,alpha=0.2)+
#   
...
#   geom_point(data=H_Sc1_Or1, aes(x=geo_entity2,y=qD,color=geo_entity2),position = position_jitter(w = 0.02, h = 0),size=0.25,alpha=0.2)+
#   
...
#   geom_point(data=H_Sc1_Or2, aes(x=geo_entity2,y=qD,color=geo_entity2),position = position_jitter(w = 0.02, h = 0),size=0.25,alpha=0.2)+
#   
