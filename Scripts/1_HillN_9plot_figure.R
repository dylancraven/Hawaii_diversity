...
HillN_2<-read.csv("Cleaned_Data/Scen2_Natives_9plots_HillN.csv")
...
write.csv(HillNN_f,"Cleaned_Data/summaryHillNumbers_9plots.csv",row.names = FALSE)
...
png(filename="Figures/HillN_Natives_9plots_Fig3.png", 
    units="in", 
    width=7, 
    height=7, 
    pointsize=2, 
