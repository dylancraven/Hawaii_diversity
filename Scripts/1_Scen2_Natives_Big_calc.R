...
Scen2_curves.tog<-do.call(rbind.data.frame,curveZ)

Scen2_orders.tog<-do.call(rbind.data.frame,orderZ)

Scen2_rangez.tog<-do.call(rbind.data.frame,rangeZ)

Scen2_rad.tog<-do.call(rbind.data.frame,radZ)
