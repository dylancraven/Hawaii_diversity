...
scen3_selplots<-read.csv("Cleaned_Data/Scen3_Natives_SelPlots_ElevRange.csv", header=TRUE)
...
write.table(orders.tog,"Cleaned_Data/Scen3_Natives_ElevR_10plots_HillN.csv",sep=",",row.names=F)

write.table(curves.tog,"Cleaned_Data/Scen3_Natives_ElevR_10plots_curves_estimates.csv",sep=",",
            row.names=F)
...
write.table(envs,"Cleaned_Data/Scen3_Natives_ElevR_10plots_Envconditions_summarized.csv",
            sep=",",row.names=F)

write.table(beta.tog,"Cleaned_Data/Scen3_Natives_ElevR_10plots_BetaPIE.csv",sep=",",
            row.names=F)

write.table(rad.tog,"Cleaned_Data/Scen3_Natives_ElevR_10plots_RADs.csv",sep=",",row.names=F)