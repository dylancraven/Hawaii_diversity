...
rad.tog2<-read.csv("Cleaned_Data/Scen2_Natives_9plots_RADs.csv",sep=",",header=T)
...
write.table(rad_tog2,"Cleaned_Data/Scen2_Natives_9plots_RAD_GAMMestimates.csv",sep=",",row.names=T)

##########
# SCEN 3 #
##########

rad.tog3<-read.csv("Cleaned_Data/Scen3_Natives_9plots_RAD.csv",sep=",",header=T)
...
write.table(rad_tog3,"Cleaned_Data/Scen3_Natives_9plots_RAD_GAMMestimates.csv",sep=",",row.names=T)
