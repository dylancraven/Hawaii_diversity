...
sac.tog<-read.csv("Cleaned_Data/Scen2_Natives_9plots_curves_estimates.csv")
...
write.table(sac_togg,"Cleaned_Data/Scen2_Natives_9plots_SACs_GAMMestimates.csv",sep=",",row.names=T)

##########
# SCEN 3 #
##########

sac.tog2<-read.csv("Cleaned_Data/Scen3_Natives_9plots_curves_estimates.csv")
...
write.table(sac_togg2,"Cleaned_Data/Scen3_Natives_9plots_SACs_GAMMestimates.csv",sep=",",row.names=T)
