...
beta_div<-read.csv("Cleaned_Data/Scen3_Natives_10plots_BetaPIE.csv",stringsAsFactors = FALSE)
...
write.csv(summ, "Cleaned_Data/Scen3_natives_VarPart_summ.csv",row.names=FALSE)
