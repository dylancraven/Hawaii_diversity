...
scen2_HillN<-read.csv("Cleaned_Data/Scen2_Aliens_10plots_HillN.csv")

scen2_SACs<-read.csv("Cleaned_Data/Scen2_Aliens_10plots_curves_estimates.csv")

scen2_beta<-read.csv("Cleaned_Data/Scen2_Aliens_10plots_BetaPIE.csv")

scen2_RAD<-read.csv("Cleaned_Data/Scen2_Aliens_10plots_RADs.csv")
...
scen3_HillN<-read.csv("Cleaned_Data/Scen3_Aliens_10plots_HillN.csv")

scen3_SACs<-read.csv("Cleaned_Data/Scen3_Aliens_10plots_curves_estimates.csv")

scen3_beta<-read.csv("Cleaned_Data/Scen3_Aliens_10plots_BetaPIE.csv")

scen3_RAD<-read.csv("Cleaned_Data/Scen3_Aliens_10plots_RAD.csv")
