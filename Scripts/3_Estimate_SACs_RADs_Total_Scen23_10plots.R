...
sac.tog<-read.csv("Cleaned_Data/Scen2_Total_10plots_curves_estimates.csv")
...
sac.tog3<-read.csv("Cleaned_Data/Scen3_Total_10plots_curves_estimates.csv")
...
sac_scen3_r2<-r.squaredGLMM(b,pj2014 = FALSE)
...
rad.tog2<-read.csv("Cleaned_Data/Scen2_Total_10plots_RADs.csv",sep=",",header=T)
...
# make predictions
pred2 <- ggpredict(rad2, terms = c("logRelAbund [n=9]","geo_entity2"))
...
rad.tog3<-read.csv("Cleaned_Data/Scen3_Total_10plots_RAD.csv",sep=",",header=T)
...
# make predictions
pred3 <- ggpredict(rad3, terms = c("logRelAbund [n=9.34]","geo_entity2"))
...
togg3<-plot_grid(p_scen2,p_scen3,rad_scen2,rad_scen3,
                 labels=c("a)","b)","c)","d)"),label_size = 6,
                 ncol=2)

png(filename="Figures/SACs_RADs_Total_10plots_FigS3.png", 
    units="in", 
    width=8, 
    height=6, 
    pointsize=2, 
...
save(sac_scen2_r2,sac_scen3_r2, summ_sac_scen2,summ_sac_scen3, 
     rad_scen2_r2,rad_scen3_r2, summ_rad_scen2,summ_rad_scen3,file="Cleaned_Data/model_summary_SAC_RAD_Total_10plots.RData")
