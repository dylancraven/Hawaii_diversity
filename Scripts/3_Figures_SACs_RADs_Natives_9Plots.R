...
SACs_2<-read.csv("Cleaned_Data/Scen2_Natives_9plots_SACs_GAMMestimates.csv")

RAD_2<-read.csv("Cleaned_Data/Scen2_Natives_9plots_RAD_GAMMestimates.csv")

##################
# Scenario 3 #####
##################

SACs_3<-read.csv("Cleaned_Data/Scen3_Natives_9plots_SACs_GAMMestimates.csv")

RAD_3<-read.csv("Cleaned_Data/Scen3_Natives_9plots_RAD_GAMMestimates.csv")
...
png(filename="Figures/SACs_RADs_Natives_9plots_Fig3.png", 
    units="in", 
    width=8, 
    height=6, 
    pointsize=2, 
