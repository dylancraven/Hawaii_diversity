...
Scen3_AllSpp_BetaS_r2<-summary(lm_BetaS_All)$r.squared
Scen3_AllSpp_BetaS_modelsumm<-tidy(Anova(lm_BetaS_All,test.statistic="F"))
Scen3_AllSpp_BetaS_modelpred<-ggeffect(lm_BetaS_All, terms="geo_entity2", x.as.factor = T)
...
Scen3_NativesSpp_BetaS_r2<-summary(lm_BetaN_All)$r.squared
Scen3_NativesSpp_BetaS_modelsumm<-tidy(Anova(lm_BetaN_All,test.statistic="F"))
Scen3_NativesSpp_BetaS_modelpred<-ggeffect(lm_BetaN_All, terms="geo_entity2", x.as.factor = T)

#######
# out #
#######
save(Scen3_AllSpp_BetaS_r2,Scen3_AllSpp_BetaS_modelsumm,Scen3_AllSpp_BetaS_modelpred, 
     Scen3_NativesSpp_BetaS_r2,Scen3_NativesSpp_BetaS_modelsumm,Scen3_NativesSpp_BetaS_modelpred, 
     file="Cleaned_Data/Scen3_All_Native_BetaS_anova_summary.RData")