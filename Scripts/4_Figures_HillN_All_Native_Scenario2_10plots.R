...
HillNN<-melt(HillNN, id.vars=c("geo_entity2","Scenario","iteration","m","method","SC"),measure.vars = c("q...0","q...1","q...2"),
...
png(filename="Figures/HillN_All_Natives_Scenario2_10plots_FigS2.png", 
    units="in", 
    width=5, 
    height=7, 
    pointsize=2, 
