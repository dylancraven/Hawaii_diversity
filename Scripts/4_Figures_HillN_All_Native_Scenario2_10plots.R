...
load("Cleaned_Data/Scen2_All_Native_HillN_anova_summary.RData")

HillN_All<-read.csv("Cleaned_Data/Scen2_Total_10plots_HillN.csv")
HillN_Natives<-read.csv("Cleaned_Data/Scen2_Natives_10plots_HillN.csv")
...
Scen2_AllSpp_q0_modelpred$Scenario<-"All species"
Scen2_AllSpp_q0_modelpred$Order<-0

Scen2_AllSpp_q0_modelpred<-select(Scen2_AllSpp_q0_modelpred, Scenario,Order, geo_entity2=x, qD=predicted,
                                  qD.LCL=conf.low, qD.UCL=conf.high)

Scen2_NativesSpp_q0_modelpred$Scenario<-"Native species"
Scen2_NativesSpp_q0_modelpred$Order<-0
Scen2_NativesSpp_q0_modelpred<-select(Scen2_NativesSpp_q0_modelpred,Scenario,Order,geo_entity2=x, qD=predicted,
                                  qD.LCL=conf.low, qD.UCL=conf.high)

Scen2_AllSpp_q2_modelpred$Scenario<-"All species"
Scen2_AllSpp_q2_modelpred$Order<-2

Scen2_AllSpp_q2_modelpred<-select(Scen2_AllSpp_q2_modelpred, Scenario,Order, geo_entity2=x, qD=predicted,
                                  qD.LCL=conf.low, qD.UCL=conf.high)

Scen2_NativesSpp_q2_modelpred$Scenario<-"Native species"
Scen2_NativesSpp_q2_modelpred$Order<-2
Scen2_NativesSpp_q2_modelpred<-select(Scen2_NativesSpp_q2_modelpred,Scenario,Order,geo_entity2=x, qD=predicted,
                                      qD.LCL=conf.low, qD.UCL=conf.high)

# join
HillNN_f<-rbind.data.frame(Scen2_AllSpp_q0_modelpred,Scen2_NativesSpp_q0_modelpred,
                           Scen2_AllSpp_q2_modelpred,Scen2_NativesSpp_q2_modelpred)
...
Hill_Or0<-ggplot(H_Sc2_Or0) +
  ...
  geom_point(data=H_Sc2_Or0,aes(x = x_axis, y = qD, group=Isl_Scen, colour=Scenario), 
...
ggsave(filename = file.path("Figures", "HillN_All_Natives_Scenario2_10plots_FigS2.png"), 
       width    = 8.7, 
       height   = 11, 
       units    = "cm",dpi=900)
