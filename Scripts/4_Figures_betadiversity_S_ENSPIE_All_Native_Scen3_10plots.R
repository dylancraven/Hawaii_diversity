...
load("Cleaned_Data/Scen3_All_Native_BetaS_anova_summary.RData")
...
Scen3_AllSpp_BetaS_modelpred$Scenario<-"All species"

Scen3_AllSpp_BetaS_modelpred<-select(Scen3_AllSpp_BetaS_modelpred, Scenario,geo_entity2=x, beta=predicted,
                                     beta.LCL=conf.low, beta.UCL=conf.high)

Scen3_NativesSpp_BetaS_modelpred$Scenario<-"Native species"
Scen3_NativesSpp_BetaS_modelpred<-select(Scen3_NativesSpp_BetaS_modelpred,Scenario,geo_entity2=x, beta=predicted,
                                         beta.LCL=conf.low, beta.UCL=conf.high)

BetaS_f<-rbind.data.frame(Scen3_AllSpp_BetaS_modelpred,Scen3_NativesSpp_BetaS_modelpred)
